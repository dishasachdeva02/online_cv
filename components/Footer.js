    ...
    <div className='h-[250px] bg-neutral-800 font-light text-xs p-4 pt-6 text-white'>
      ...
      <ul className='text-center text-base'>Contact Developer</ul>
        <ul className='flex flex-col'>
          ...
          <Links_footer title={"GitHub"}  link={''} image={github_footer}/>      
          <Links_footer title={"Hackerrank"}  link={''} image={Hackerrank_footer}/>      
          <Links_footer title={"Instagram"}  link={''} image={instagram_footer}/>      
          <Links_footer title={"Mail"}  link={''} image={mail_footer}/>      
          </ul>
        </ul>
        <ul className='text-center'>About us</ul>
        <div className='flex text-center justify-center text-[9px] text-gray-500'>
          DISHA SACHDEVA | SRM UNIVERSITY <br/>https://disha-onlinecv.vercel.app/<br/>
        </div>
      </div>
    </div>
  )
