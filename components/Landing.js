...
import c from '../assets/svgs/c.png'
...
import spotify from '../assets/svgs/spotify.png'
        ...
        <div className='flex justify-center items-center flex-col lg:mt-12 lg:flex-row w-full pt-10 px-6 md:px-16  text-center'>
            <div className='flex w-full py-6 font-bold tracking-wider h-full'>
                <h1 className='lg:p-6 lg:justify-center lg:items-start lg:text-[50px] lg:flex lg:flex-col text-transparent text-[25px] bg-clip-text bg-gradient-to-r from-[#fff] to-[#7fb6d5] font-bold text-left'>
                    ...
                    <Typewriter
                        options={{
                            strings: ['Web Developer', 'Organizer' , "Designer" ],
                            autoStart: true,
                            loop: true,
                        }}
                    />
                    <div className='text-[12px] hidden lg:flex paragraph font-medium lg:mt-8 w-full'>
                        <span>
                        Hey !! Im Disha Sachdeva, a final-year B.Tech student at SRM University in Chennai. My passion for technology has driven me to develop skills in both Android and web development, creating user-friendly applications and websites. I have strong organizational skills, leading and managing various events. My outstanding academic performance reflects my hard work and dedication to learning. Im eager to continue growing my skills and achieving my goals in the future.
                        </span>
                    </div>
                </h1>
        ...
        <div className='bg-zinc-900'>
            <div className='Slide-2 text-xs text-gray-500 text-left'>
                <div className='paragraph lg:hidden px-8 py-8 w-full lg:w-1/2'>
                    <span>
                    Hey !! Im Disha Sachdeva, a third-year B.Tech student at SRM University in Chennai. My passion for technology has driven me to develop skills in both Android and web development, creating user-friendly applications and websites. I have strong organizational skills, leading and managing various events. My outstanding academic performance reflects my hard work and dedication to learning. Im eager to continue growing my skills and achieving my goals in the future.
                    </span>
                </div>
            </div>
            <div className='lg:flex flex-1 flex-row'>
                ...
                <div className='flex lg:flex-1 flex-col justify-centerskill p-4'>
                    ...
                    <div className='grid grid-cols-4 gap-4 w-full'data-aos="fade-right">
                        ...
                        <div className='grid place-content-center'><Image  src={Html} height={100} width={100} alt='Profile pic' className='m-2'/></div>
                    </div>
                </div>
            ...
            <div className='p-4 text-white flex flex-col'>
                ...
                <div className='card body flex flex-wrap justify-center lg:gap-10 gap-5 mt-6 lg:justify-start lg:p-6'>
                    <Coming_soon data-aos="zoom-in-up" internship_title={"MIT Square"} image_link={techno} desc={"Learned about various python libraries"}/>
                    <Coming_soon internship_title={"Code Clause"} design={""} image_link={seedit} desc={"Data analyst intern"}/>
                </div>
            </div>
            ...
            <div className='p-4 text-white flex flex-col'>
                ...
                <div className='card body flex flex-wrap justify-center lg:gap-10 gap-5 mt-6 lg:justify-end lg:p-6'>
                    <Skillcard image={spotify} classdesign={"object-contain p-2"} heading={"IoT Based Home Automation"} paragraph={"IOT Home automation system"} button={"know more"}/>
                    <Skillcard image={Resumint} classdesign={"object-contain p-2"} heading={"Anonymous and Genuine Tip-Offs"} paragraph={"Research based project"} button={"know more"}/>
                    {/* <Skillcard image={android_app} classdesign={"object-contain p-2"} heading={"Anonymous and Genuine Tip-Offs"} paragraph={"Seed it Solution paragraph | Seed it Solution paragraph"} button={"know more"}/> */}
                </div>
            </div>
            ...
            <div className='p-4 text-white flex flex-col'>
                ...
                <div className='card body flex flex-wrap justify-center items-center flex-col lg:flex-row lg:gap-10 gap-5 mt-6 lg:justify-start lg:p-6'>
                    ...
                    <Skill_card image_link={hackathon} card_title={"Organized Hackathon"} />
